      ...
      <div className="bg-gradient-to-t from-blue-400 to-orange-100">
        <div className="flex items-center justify-center w-full h-screen">
          <div className="flex flex-col items-center mb-16 ">
            <h2 className="text-2xl sm:text-3xl">Welcome to the</h2>
            <h1 className="mb-4 text-4xl font-bold sm:text-6xl ">Mini Loan App</h1>
            <p className="text-sm sm:text-base">Easly Apply for Loan and Manage Installments</p>
